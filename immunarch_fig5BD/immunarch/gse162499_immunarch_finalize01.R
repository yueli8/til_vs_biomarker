...
library(immunarch)
setwd("~/geo/gse162499")
file_path="~/geo/gse162499/immunarch_data/immunarch"
...
file_path="~/geo/gse162499/immunarch_data/immunarch_blood"
immdata<-repLoad(file_path)
...
file_path="~/geo/gse162499/immunarch_data/immunarch_tumor"
immdata<-repLoad(file_path)
tc2  <-  trackClonotypes ( immdata$data , list (1,10), .col  =  "nt" )
head(tc2)
p2  <-  vis ( tc2 )
