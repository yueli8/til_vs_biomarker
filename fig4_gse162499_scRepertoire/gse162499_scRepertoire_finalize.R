#install must use install_github command:
#library(devtools)
#devtools::install_github("ncborcherding/scRepertoire")
#if use following command, no result:
#devtools::install("scRepertoire",force = TRUE)
#install above github command work,any other command not work
#https://ncborcherding.github.io/vignettes/vignette.html#correct pdf
library(Seurat)
library(scRepertoire)
packageVersion('scRepertoire')# version should be 1.7
setwd("~/geo/gse162499")
